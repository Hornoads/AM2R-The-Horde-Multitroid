...
with (oCharacter)
{
    if collision_line(x, y, x, (y + 32), oSolid, false, true)
    {
        if (facing == LEFT)
        {
            ...
            {
                spwn = instance_create((view_xview[0] - (oControl.widescreen_space / 2)), ((y - 24) - irandom(24)), oHornoad)
                spwn.facing = 1
                spwn.state = 4
            }
        }
        else if (facing == RIGHT)
        {
            ...
            {
                spwn = instance_create((view_xview[0] + spwnoffset), ((y - 24) - irandom(24)), oHornoad)
                spwn.facing = -1
                spwn.state = 4
            }
        }

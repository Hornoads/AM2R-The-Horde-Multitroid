...
global.mod_omegadamagebacksuper = mod_changes_2(ini_read_real("Omega", "DamageBackSuper", 97), 97)
...
global.mod_torizodamageghost = mod_changes(ini_read_real("Torizo", "DamageGhost", 15), 15)
